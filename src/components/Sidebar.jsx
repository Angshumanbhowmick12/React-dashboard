...
const Sidebar = () => {
   const {activeMenu,setActiveMenu,screenSize,currentColor}=useSateContext()
  ...
  const activeLink='flex items-center gap-5 pl-4 pt-3 pb-2.5 rounded-leg text-white text-md m-2'
